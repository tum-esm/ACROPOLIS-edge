...
- Download and install **Raspberry Pi OS Lite Legacy (64-bit, Bookworm)**.
...
## 4. Install Python 3.12 and Poetry
...
## (Optional) 8. Provision and Setup Gateway for Thingsboard

Skip if you want to create an template image for multiple systems
